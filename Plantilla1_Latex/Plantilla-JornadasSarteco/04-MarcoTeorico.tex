...
Se emplea el formato \textit{Portable GrayMap} (PGM) en su variante P2 (ASCII). Este formato permite una representación sencilla de la matriz de intensidades de gris, facilitando la validación visual del suavizado mediante la inspección de los archivos de salida procesados por cada una de las versiones del kernel.